<x-publik>
    <x-slot name="title">Sejarah KAMMI Tasikmalaya</x-slot>
    <div class="page-header">
        <div class="page-header-inner">
            <div class="breadcrumb"><a href="/">Beranda</a><span class="breadcrumb-sep">›</span><span>Tentang</span><span class="breadcrumb-sep">›</span><span>Sejarah</span></div>
            <h1>{{ $konten->judul ?? 'Sejarah KAMMI Daerah Tasikmalaya' }}</h1>
        </div>
    </div>
    <div style="padding:56px 2.5rem;max-width:900px;margin:0 auto;">
        ...
        @else
            <div style="text-align:center;padding:80px 24px;color:#9ca3af;">
                ...
                <p style="font-size:16px;">Konten sejarah belum diisi. Tambahkan melalui dashboard admin.</p>
